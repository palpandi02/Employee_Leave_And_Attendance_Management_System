...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(ClockingException.class)
    public ResponseEntity<Map<String, Object>> handleResourceNotFound(ClockingException ex) {
    ...
    public ResponseEntity<Map<String, Object>> handleBadRequest(EmployeeNotFound ex) {
