...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleResourceNotFound(AlreadyProcessedException ex) {
        return buildResponse(HttpStatus.NOT_FOUND, ex.getMessage());
    }
    @ExceptionHandler(InvalidRequest.class)
    public ResponseEntity<Map<String, Object>> handleResourceNotFound(InvalidRequest ex) {
        return buildResponse(HttpStatus.NOT_FOUND, ex.getMessage());
    }
 
    @ExceptionHandler(InsufficientLeaveBalanceException.class)
    public ResponseEntity<Map<String, Object>> handleBadRequest(InsufficientLeaveBalanceException ex) {
        return buildResponse(HttpStatus.BAD_REQUEST, ex.getMessage());
    }
    @ExceptionHandler(NoResultFoundException.class)
    public ResponseEntity<Map<String, Object>> handleResourceNotFound(NoResultFoundException ex) {
        return buildResponse(HttpStatus.NOT_FOUND, ex.getMessage());
    }
 
    @ExceptionHandler(RequestNotFoundException.class)
    public ResponseEntity<Map<String, Object>> handleBadRequest(RequestNotFoundException ex) {
        return buildResponse(HttpStatus.BAD_REQUEST, ex.getMessage());
    }
